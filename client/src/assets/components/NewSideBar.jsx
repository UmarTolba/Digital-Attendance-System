...
function NewSideBar()
{
    ...
    return(
        <div className="bg-blue-800 p-3 text-black w-[20%] flex flex-col">
            ...
            <button onClick={()=>{logout()}} className="bg-blue-900 p-1 rounded-md transition-all duration-200 text-sm text-white hover:bg-white hover:text-blue-900 m-1" to="/Logout">Logout</button>
        </div>
    )
}

...
{   
    ...
    return(
        <div className="bg-blue-600 p-3 text-black w-[20%] flex flex-col">
            ...
            <Link 
            to={user && user._id ? `/Profile?user=${user._id}` : "/Profile"}
            
            className="bg-blue-800 p-1 pl-3 rounded-md transition-all duration-200 text-lg text-white hover:bg-white hover:text-blue-900 m-1"
            >
